...
├── src/
│ ├── main.js ← Injects UI & handles mobile menu
...
```bash
git clone https://github.com/abyu301/my-tailwind-vite.git
cd my-tailwind-vite
npm install
npm run dev

****  Open the browser at the URL Vite provides (e.g., http://localhost:5173).
